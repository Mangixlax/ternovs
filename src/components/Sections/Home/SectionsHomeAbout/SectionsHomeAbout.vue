<template>
  <div :class="$style['about']">
    <div :class="$style['about__grid']">
      <div :class="$style['about__grid-text']">
        <h2>
          Оказываем услуги <br />
          по 4 направлениям
        </h2>
      ...
      <div :class="$style['about__grid-decore']">
        <img
          ...
          :class="$style['about__grid-decore-image']"
        />
        <img
          :src="$img('/layout/diamond.png')"
          alt="diamond"
          :class="$style['about__grid-decore-diamond']"
        />
      </div>
      <div :class="$style['about__grid-row']">
        <div :class="$style['about__grid-row-container']">
          <sections-home-about-item
            v-for="(item, index) in about"
            :key="index"
            :item="item"
          />
        </div>
        <div :class="$style['about__grid-row-slider']">
          <swiper
            ref="mySwiper"
          ...
          >
            ...
            >
              <sections-home-about-item :item="item" />
            </swiper-slide>
