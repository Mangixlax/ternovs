  ...
  <main :class="$style['services']">
    <section :class="$style['services__grid']">
      <div :class="$style['services__grid-container']">
        ...
        <span>
          Работа ведётся основным направлениям: ортопедия, хирургия,
          терапия,ортодонтия, а также детская стоматология. Новейшее
          оборудование и методики позволяют добиться блестящего результата
          работы как в прямом, так и переносном смысле. Тысяч довольных
          пациентов уже получили свою возможность снова улыбаться. Возможно,
          следующим счастливым человеком сможете стать именно Вы.
        </span>
        <base-scroll-block>
