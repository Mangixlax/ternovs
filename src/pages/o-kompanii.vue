...
export default defineComponent({
  ...
  head() {
    return getHead({
      title: `О нас - Авторская стоматология Терновых | Ternovs.ru`,
      description: `Узнайте больше о нашей команде профессионалов и нашем подходе к стоматологии. Мы ставим здоровье и комфорт пациентов на первое место.`,
      route: this.$route,
    })
  },
  created() {
